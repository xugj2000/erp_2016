<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddShelfNo.aspx.cs" Inherits="Warehousing.Storage.AddShelfNo" %>
      ...
      <table width="100%" cellpadding="4" class="style1">
          ...
          <tr>
             ...
             <asp:Repeater ID="StockList" runat="server">
              <ItemTemplate>  
              <tr bgcolor="#FFFFFF"><td><%#Eval("p_txm")%></td><td><%#Eval("p_spec")%></td><td><%#Eval("p_model")%></td><td><input type="hidden" name="stock_id" value="<%#Eval("stock_id")%>"/><input type="text" name="shelf_no" value="<%#Eval("shelf_no")%>" class="width4" onclick="select(this)" maxlength=10/></td></tr>
              </ItemTemplate>
            </asp:Repeater>
            </table>
               </td>
