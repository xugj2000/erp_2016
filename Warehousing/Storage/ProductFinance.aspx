<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductFinance.aspx.cs" Inherits="Warehousing.Storage.ProductFinance" %>
    ...
    $(function () {
        $('.DoFinance').click(function () {
            $.dialog({
                ...
                min: false,
                lock: true,
                content: 'url:/Storage/addFinance.aspx?sm_id=' + <%=sm_id %> +'&id=' + $(this).attr("data") + '&r=' + (new Date()).toUTCString(),
                ok: false,
                cancelVal: '关闭',
...
<body>
<form runat="server" id="form1" action="ProductFinance.aspx">
<div id="div1">
<table width="1000" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC" class="tableBorder">
<tr bgcolor="#FFFFFF"> 
<td  align="center"><b><strong>出入库工单付款查看</strong></b></td>
</tr>
<tr bgcolor="#FFFFFF">
