<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductNeedDetail.aspx.cs" Inherits="Warehousing.Storage.ProductNeedDetail" %>
...
<div id="view" style="width:800px;margin:0 auto;text-align:center">		
     <table width="100%" cellpadding="4" class="style1">
       <tr>
    <td colspan="2" style="font-size:20px;text-align:center;font-weight:bold;height:40px;">申请调货清单
    </td>
  </tr>
                    <tr>
        <td colspan="10" style="text-align:left">
     &nbsp; &nbsp; &nbsp; &nbsp;申请仓库：<%=Warehousing.Business.StorageHelper.getWarehouseName(warehouse_id_to)%>
      &nbsp; &nbsp; &nbsp; &nbsp;发货仓库：
...
<table width="100%" bgcolor="#FFFFFF" id="mytable" border="1" align="center" cellpadding="5" cellspacing="0" >
  ...
  <td style="height:20px;">合计 </td>
	...
	<td><%=total_price%></td>
                    ...
                    <tr>
        <td colspan="10" style="text-align:left">制表时间:<%=sm_time%>
     审核人:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
   &nbsp; 申请人姓名:<%=sm_operator %>
    &nbsp; 备注:<%=sm_remark%>
    </td>
...
<asp:Button ID="Button1" runat="server" Text=" 审 核 " onclick="Button1_Click" />
 ...
 <script language="javascript" type="text/javascript"> 
	...
	function CreateFormPage() {
        ...
        iPageHigh=iPageHigh+30*<%=MemberList.Items.Count+1%>;//加上公共信息
