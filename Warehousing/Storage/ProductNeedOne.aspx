<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductNeedOne.aspx.cs" Inherits="Warehousing.Storage.ProductNeedOne" %>
...
<tr bgcolor="#FFFFFF">
  ...
  <tr bgcolor="#FFFFFF" align="center">
    ...
    <td><input name="p_model" type="text" class="text width2" value='<%#Eval("p_model")%>' readonlytd>
    <td><input name="p_quantity" type="text" class="text width4" value='<%#Eval("p_quantity")%>' /></td>
	<td><input name="p_price" type="text" class="text width4" value='<%#Eval("p_price")%>' readonly/></td>
