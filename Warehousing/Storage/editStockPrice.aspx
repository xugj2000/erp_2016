<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editStockPrice.aspx.cs" Inherits="Warehousing.Storage.editStockPrice" %>

<html><head><title>价格管理</title>
...
<tr bgcolor="#FFFFFF"> 
<td  align="center"><b><strong>价格调整</strong></b></td>
</tr>
<tr bgcolor="#FFFFFF">
  <td  align="center" bgcolor="#FFFFFF">
      ...
      <table width="100%" cellpadding="4" class="style1">
          ...
          <tr>
             ...
             <tr bgcolor="#FFFFFF"><td>条码</td><td>规格</td><td>型号</td><td>建议价格</td><td>当前价格</td></tr>
             <asp:Repeater ID="StockList" runat="server">
              <ItemTemplate>  
              <tr bgcolor="#FFFFFF"><td><%#Eval("pro_txm")%></td><td><%#Eval("pro_spec")%></td><td><%#Eval("pro_model")%></td><td><%#Eval("pro_marketprice")%></td><td><input type="hidden" name="stock_id" value="<%#Eval("stock_id")%>"/><input type="text" name="stock_price" value="<%#Convert.ToDouble(Eval("stock_price"))%>" class="width4" onclick="select(this)"/></td></tr>
              </ItemTemplate>
            </asp:Repeater>
            </table>
               </td>
