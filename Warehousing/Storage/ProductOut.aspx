        ...
        <tr  style='background-color:<%#(Container.ItemIndex%2==0)?"#FFFFFF":"#F3F3F3"%>' align="center">
         <td><%#Eval("sm_id")%></td>
		  ...
		  <td>
              ...
              &nbsp;<a href="ProductReturn.aspx?return_id=<%#Eval("sm_id")%>" <%# Convert.ToInt32(Eval("sm_type")) == (int)Warehousing.Business.StorageType.生产出库 ? "style='display:none;'" : ""%>>退货</a>
            <a href="addProductOut.aspx?direct_id=<%#Eval("sm_id")%>&outType=<%#Eval("sm_type")%>" <%#Convert.ToInt32(Eval("sm_status")) != 2 ? "style='display:none;'" : ""%>>重出</a>
