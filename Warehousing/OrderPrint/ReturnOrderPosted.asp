...
%>
<form name="form2" action="ReturnOrderPrint.asp?isPosted=yes" method="post" target="_blank">
<%Randomize   Timer() 
      ...
      <td valign="top" nowrap> 全选
        ...
        <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#CCCCCC">
          ...
          <tr bgcolor="#FFFFFF" >
            ...
            <td align="center"><%=DeliverTime%>            </td>
          </tr>
          <tr bgcolor="#FFFFFF" >
...
<%'分页
		alink="ReturnOrderPosted.asp?dingdan="&dingdan&"&userid="&userid&"&namekey="&namekey&"&post_date="&post_date
