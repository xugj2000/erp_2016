...
function PopUp(id, config){
	...
	this.imgMin = "http://www.bokee.net/includes/pop/images/min.gif";
	this.imgMax = "http://www.bokee.net/includes/pop/images/max.gif";
}
...
//							height:15px;\
//							\
//							background-image:url("http://www.bokee.net/includes/pop/images/min.gif");';
//	
...
//		$addEL(sBtn,"click",$cancelEvent,true);
		...
		btn.style.cssText='position:absolute;\
							...
							height:15px;\
							\
							background-image:url("http://www.bokee.net/includes/pop/images/close.gif");';
...
function job(){
	...
	*/
	var cfg={
		...
		//content url
		contentUrl		: "inc/flash/smDiv.asp",
