/*
##############################################
调用方法：<INPUT name="TextBox1" id=TextBox1 type=text onClick="return Calendar('TextBox1');" readonly >
##############################################
*/
var MonthDNum=new Array(0,31,28,31,30,31,30,31,31,30,31,30,31);
var MonthText=new Array("","一","二","三","四","五","六","七","八","九","十","十一","十二");
...
'<div id="sMonth" onclick="ShowSelect(\'SelectMonth\',\'M\');">'+MonthText[month]+'月</div><div id="SArr" onclick="ShowSelect(\'SelectMonth\',\'M\');"><font face="Webdings">&#54;</font></div>';
content+='</li>'+
'<li><a href="javascript:parent.Calendar_hide();">X</a></li></ul>'+
'<div id="Tools"><ul>'+
...
Calendar.style.height=86+21*Trn+'px';   //日历高度
...
eL+=p.offsetLeft;   //左边
p=p.offsetParent;}
var eH=eP.offsetHeight;     //高度
var eW=eP.offsetWidth;     //
var dH=Calendar.style.pixelHeight; //?内容高度
