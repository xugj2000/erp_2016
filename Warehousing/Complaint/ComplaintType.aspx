<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComplaintType.aspx.cs" Inherits="Warehousing.Complaint.ComplaintType" %>
...
<body>
<div style="font-size:16px;text-align:center;background-color:#EEEEEE;line-height:200%; "><strong>客诉类型管理</strong></div>
  ...
  <table width="780" border="0" align="center" cellpadding="5" cellspacing="5" style="margin-left:5px;">
      ...
      <tr>
        ...
        <asp:TextBox ID="txtTypeName" runat="server" Width="127px"></asp:TextBox> &nbsp; 
            ...
            &nbsp;<asp:Button ID="Button1" runat="server" Text="增加类别" OnClick="Button1_Click" />
        </td>
      </tr>
  </table>
